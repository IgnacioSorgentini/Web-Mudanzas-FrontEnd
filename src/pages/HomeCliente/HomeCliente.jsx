    ...
    return(
        <div style={{display:"flex", backgroundColor:"#D9D9D9",flex:1,flexDirection:"column"}}>
          ...
          <div style={{display:"flex", justifyContent:"space-between",flexDirection:"row", borderRadius:"0px 0px 7px 7px",marginLeft:"20px", marginRight:"20px", }}>
            <div style={{display:"flex", flexDirection:"row", backgroundColor:"#ADADAD", borderRadius:"0px 0px 7px 7px"}}>
            ...
            <div style={{backgroundColor:"#ADADAD", display:"flex", boxSizing:"border-box", paddingLeft:"10px", paddingRight:"10px", paddingTop:"6px", paddingBottom:"10px", borderRadius:"0px 0px 7px 7px"}}>
