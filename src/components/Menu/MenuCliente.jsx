...
function MenuCliente() {
    ...
    return(
        <div className="menu">
            <div style={{display:"flex",backgroundColor:"#58668B",height:"10vh",flexDirection:"row",justifyContent:"space-between" , borderRadius:"5px", marginTop:"20px", marginLeft:"20px", marginRight:"20px",alignItems:"center", paddingLeft:"10px", paddingRight:"10px"}}>
            ...
            <div>
              ...
              <IconButton onClick={handleMenu} sx={{ p: 0 }}>
                <Avatar alt="Remy Sharp" src="/Menu/2.jpg" style={{color:'#58668B',backgroundColor:"#F2DC9B",fontSize:'30px'}} />
              </IconButton>
              <Menu
                id="menu-appbar"
                anchorEl={anchorEl}
