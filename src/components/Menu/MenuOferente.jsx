...
function MenuCliente() {
    ...
    return(
        <div className="menu">
            <div style={{display:"flex",backgroundColor:"#8D8D9B",height:"10vh",flexDirection:"row",justifyContent:"space-between" , borderRadius:"5px",margin:"20px",alignItems:"center", paddingLeft:"10px", paddingRight:"10px"}}>
