...
function Comentario({usuario, texto, puntuacion}){
    return(
        <div style={{display:"flex",backgroundColor:"#F2DC9B",width:600,height:200,borderRadius:"5px",margin:"20px", padding:"20px", flexDirection:"column",justifyContent:"start", boxSizing:"border-box"}} >
